...
router.post('/register', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const token = jsonwebtoken_1.default.sign({ userId: user.id, userRole: user.role }, secretKey, { expiresIn: '10h' });
...
router.post('/handleCreateUser', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const db = yield (0, database_1.openDb)();
        ...
        yield db.run(`INSERT INTO users 
...
router.post('/saveSubUserData', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const db = yield (0, database_1.openDb)();
        const userData = req.body;
...
router.post('/saveSubmissionUser', authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const db = yield (0, database_1.openDb)();
        ...
        yield db.run(`UPDATE users SET submissiveUsers = ? WHERE id = ?`, [JSON.stringify(currentSubmissiveUsers), userId]);
...
router.get('/getSubmissiveUsers', authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const db = yield (0, database_1.openDb)();
        const userId = req.user.userId;
        const user = yield db.get('SELECT submissiveUsers, role FROM users WHERE id = ?', [userId]);
        ...
        const submissiveUsersData = yield db.all(`SELECT * FROM users WHERE username IN (${placeholders})`, submissiveUsers);
